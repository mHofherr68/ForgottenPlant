...
public class MainMenuController : MonoBehaviour
{
    ...
    {
        if (GameSettingsManager.Instance != null && GameSettingsManager.Instance.HasUnsavedChanges)
        {
            if (onSavePanel != null)
                onSavePanel.SetActive(true);
    ...
    public void SaveAndCloseOptions()
    {
        ...
        if (!GameSettingsManager.Instance.HasUnsavedChanges)
        {
            if (onSavePanel != null)
                onSavePanel.SetActive(true);
    ...
    private void OnOptionChanged()
    {
        ...
        if (GameSettingsManager.Instance != null)
            GameSettingsManager.Instance.MarkAsChanged();
