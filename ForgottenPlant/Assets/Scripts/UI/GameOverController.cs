...
//    [Header("Debug")]
//    [SerializeField] private bool debugLogFade = false;
...
//        StartCoroutine(FadeMissionFailedRoutine());
//    }

//    private IEnumerator FadeMissionFailedRoutine()
//    {
//        if (debugLogFade)
//            Debug.Log($"{name}: Mission failed text visible for {visibleDuration} seconds.");
...
//        if (debugLogFade)
//            Debug.Log($"{name}: Mission failed text fade complete.");
//    }
//}
//using System.Collections;
//using TMPro;
...
//    private float previousGameStateMuteVolume = 0f;
//    private bool hasStoredPreviousVolume = false;
...
//    private void MuteGameStateAudio()
//    {
//        if (mainAudioMixer == null)
//            return;

//        if (string.IsNullOrWhiteSpace(gameStateMuteParameter))
//            return;

//        if (mainAudioMixer.GetFloat(gameStateMuteParameter, out float currentValue))
//        {
//            previousGameStateMuteVolume = currentValue;
//            hasStoredPreviousVolume = true;
//        }

//        mainAudioMixer.SetFloat(gameStateMuteParameter, mutedVolumeDb);

//        if (debugLogFlow)
//            Debug.Log($"{name}: Game state audio muted via '{gameStateMuteParameter}' to {mutedVolumeDb} dB.");
//    }

//    private void RestoreGameStateAudio()
//    {
//        if (!hasStoredPreviousVolume)
//            return;
...
//        mainAudioMixer.SetFloat(gameStateMuteParameter, previousGameStateMuteVolume);

//        if (debugLogFlow)
//            Debug.Log($"{name}: Game state audio restored via '{gameStateMuteParameter}' to {previousGameStateMuteVolume} dB.");

//        hasStoredPreviousVolume = false;
//    }
//}
using System.Collections;
using TMPro;
