...
//    [SerializeField] private float alarmSpacingCheckDistance = 2.5f;
...
//    private void HandleAlarmSpacing()
//    {
//        if (AlarmSystem.Instance == null || AlarmSystem.Instance.AlarmPoint == null)
//            return;
...
//        if (AlarmSystem.Instance.IsAlarmActive)
//            return;

//        float distanceToAlarmPoint = Vector3.Distance(transform.position, AlarmSystem.Instance.AlarmPoint.position);
//        if (distanceToAlarmPoint > alarmSpacingCheckDistance)
//        {
...
//            float otherDistanceToAlarmPoint = Vector3.Distance(other.transform.position, AlarmSystem.Instance.AlarmPoint.position);

//            bool otherHasPriority = otherDistanceToAlarmPoint < distanceToAlarmPoint;

//            if (!otherHasPriority && Mathf.Approximately(otherDistanceToAlarmPoint, distanceToAlarmPoint))
//            {
//                otherHasPriority = other.GetInstanceID() < GetInstanceID();
//            }
